...
class Version20141119194735 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE ACCARD_REGIMEN_PROTOTYPE ADD (allowDrug NUMBER(1) NOT NULL, drugGroupId NUMBER(10) DEFAULT NULL NULL)');
        ...
        $this->addSql('ALTER TABLE ACCARD_ACTIVITY_PROTOTYPE ADD (allowDrug NUMBER(1) NOT NULL, drugGroupId NUMBER(10) DEFAULT NULL NULL)');
