...
class Version20150706185439 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE accard_patient_field (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(120) NOT NULL, presentation VARCHAR(120) NOT NULL, type VARCHAR(36) NOT NULL, allowMultiple TINYINT(1) NOT NULL, addable TINYINT(1) DEFAULT \'0\' NOT NULL, configuration LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', optionId INT DEFAULT NULL, UNIQUE INDEX UNIQ_54CED4B85E237E06 (name), INDEX IDX_54CED4B8CE78B7CC (optionId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE accard_diagnosis_field (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(120) NOT NULL, presentation VARCHAR(120) NOT NULL, type VARCHAR(36) NOT NULL, allowMultiple TINYINT(1) NOT NULL, addable TINYINT(1) DEFAULT \'0\' NOT NULL, configuration LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', optionId INT DEFAULT NULL, UNIQUE INDEX UNIQ_AFEBBB2E5E237E06 (name), INDEX IDX_AFEBBB2ECE78B7CC (optionId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE accard_bhvr_proto_fld (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(120) NOT NULL, presentation VARCHAR(120) NOT NULL, type VARCHAR(36) NOT NULL, allowMultiple TINYINT(1) NOT NULL, addable TINYINT(1) DEFAULT \'0\' NOT NULL, configuration LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', optionId INT DEFAULT NULL, UNIQUE INDEX UNIQ_D2CFF6735E237E06 (name), INDEX IDX_D2CFF673CE78B7CC (optionId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE accard_attr_proto_fld (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(120) NOT NULL, presentation VARCHAR(120) NOT NULL, type VARCHAR(36) NOT NULL, allowMultiple TINYINT(1) NOT NULL, addable TINYINT(1) DEFAULT \'0\' NOT NULL, configuration LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', optionId INT DEFAULT NULL, UNIQUE INDEX UNIQ_6C2852165E237E06 (name), INDEX IDX_6C285216CE78B7CC (optionId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE accard_regimen_proto_fld (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(120) NOT NULL, presentation VARCHAR(120) NOT NULL, type VARCHAR(36) NOT NULL, allowMultiple TINYINT(1) NOT NULL, addable TINYINT(1) DEFAULT \'0\' NOT NULL, configuration LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', optionId INT DEFAULT NULL, UNIQUE INDEX UNIQ_E62A58515E237E06 (name), INDEX IDX_E62A5851CE78B7CC (optionId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE accard_activity_proto_fld (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(120) NOT NULL, presentation VARCHAR(120) NOT NULL, type VARCHAR(36) NOT NULL, allowMultiple TINYINT(1) NOT NULL, addable TINYINT(1) DEFAULT \'0\' NOT NULL, configuration LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', optionId INT DEFAULT NULL, UNIQUE INDEX UNIQ_81052DA55E237E06 (name), INDEX IDX_81052DA5CE78B7CC (optionId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
