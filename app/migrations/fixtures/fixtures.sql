...
--
-- Table structure for table `accard_log`
--

DROP TABLE IF EXISTS `accard_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `accard_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `accard_patient` VALUES (1,'103495102','John','Smith','1974-05-16 00:00:00',NULL,'male','white',NULL);
...
INSERT INTO `accard_patient_field_value` VALUES (1,NULL,NULL,NULL,3,1,1),(2,NULL,'2015-04-15 00:00:00',NULL,NULL,1,2);
...
-- Dump completed on 2015-07-14 12:35:52
